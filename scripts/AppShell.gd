...
func _show_profile() -> void:
    ...
    _label_in(
        panel,
        "SOLDE YT  •  %d" % (int(Rewards.call("balance")) if Rewards != null else 0),
...
func _show_shop_mobile_like_draft() -> void:
    ...
    _capsule_in(screen_root,Rect2(1260,620,240,36),"%d YT" % (int(Rewards.call("balance")) if Rewards != null else 0),Color("e0b84e"))
