...
func _on_classic_event(event: Dictionary) -> void:
    ...
    if t == "error":
        ...
        # Le transport et le lobby sont maintenant compatibles avec le protocole PC.
        # La synchronisation snapshot du duel est le prochain branchement réseau.
        footer_notice.text = "Duel accepté • synchronisation du moteur cross-play en préparation."
