...
func _show_shop_mobile_like_draft() -> void:
    ...
    _label_in(
        screen_root,
        "Parcours le catalogue comme\npendant le Draft.\n\nTouche une carte pour ouvrir\nsa fiche complète avant achat.",
        Rect2(42,232,238,180),
        13,
        Color("b8cad6"),
        HORIZONTAL_ALIGNMENT_CENTER,
        false
    ...
    _label_in(
        screen_root,
        "INTERFACE PRÊTE\n\nLes cartes peuvent être\nconsultées comme dans la\nBoutique Tkinter.\n\nLe solde, les prix, la\npossession et l'achat réel\nseront reconnectés au serveur\néconomie au lieu d'être\nsimulés localement.",
        Rect2(1250,306,260,268),
        13,
        Color("c8d7e2"),
        HORIZONTAL_ALIGNMENT_CENTER,
        false
...
""" % [
    ...
    # CTA volontairement non transactionnel tant que l'économie serveur Godot
    # n'est pas reconnectée. On ne crée ni faux prix, ni faux solde.
    var cta_panel := _panel_in(
        win,
        Rect2(492,584,836,104),
        Color(0.13,0.11,0.045,0.96),
        Color(0.88,0.70,0.25,0.92),
        15,
        6
    )
    var cta := _button_in(
    ...
    _label_in(
        cta_panel,
        "Le prix, le solde et la possession seront lus depuis le backend YUGITO — aucune donnée fictive locale.",
        Rect2(20,74,796,24),
        10,
        Color("d9cfa7"),
        HORIZONTAL_ALIGNMENT_CENTER,
