...
func _shop_price_label(stars: float) -> String:
    var price: int = _shop_card_price(data)
...
func _show_shop_mobile_like_draft() -> void:
    ...
    footer_notice.text = "Boutique connectée : solde, possession, rotation et achats viennent du YUGITO Auth Server."
